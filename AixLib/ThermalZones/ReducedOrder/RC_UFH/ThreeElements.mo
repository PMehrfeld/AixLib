...
equation
  ...
  connect(floorRC.port_a, resIntWallFloor.port_b)
    annotation (Line(
    points={{-10.9091,-136},{-10.9091,-130},{126,-130},{126,-120},{222,-120},{
          222,-106},{214,-106}},
    color={191,0,0},
    smooth=Smooth.None));
  ...
  connect(intWallRC.port_a, resIntWallFloor.port_a)
    annotation (Line(points={{184,-40},{184,-40},{168,-40},{168,-90},{168,-106},
          {194,-106}},
                 color={191,0,0}));
  ...
  Text(
    ...
    fillColor={215,215,215},
    fillPattern=FillPattern.Solid,
    textString="Floor Plate")}), Icon(coordinateSystem(extent={{-380,-180},{240,
            180}},      preserveAspectRatio=false), graphics={Rectangle(
    extent={{-34,52},{34,-40}},
